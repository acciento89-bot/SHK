...
struct HeizBalanceLowTemperatureReportArchiveStore {
    ...
    init(
        ...
        archiveRootURL = baseURL
            ...
            .appendingPathComponent("LowTemperatureReportArchive", isDirectory: true)
    }

    func archive(_ snapshot: HeizBalanceLowTemperatureReportSnapshot) throws -> URL {
    ...
    private func archiveFilename(snapshot: HeizBalanceLowTemperatureReportSnapshot) -> String {
