...
struct HeizBalancePumpCurveReportArchiveStore {
    ...
    init(
        ...
        archiveRootURL = baseURL
            ...
            .appendingPathComponent("PumpCurveReportArchive", isDirectory: true)
    }

    func archive(_ snapshot: HeizBalancePumpCurveReportSnapshot) throws -> URL {
    ...
    private func archiveFilename(snapshot: HeizBalancePumpCurveReportSnapshot) -> String {
