...
struct HeizBalanceTemperatureScenarioReportArchiveStore {
    ...
    init(
        ...
        archiveRootURL = baseURL
            ...
            .appendingPathComponent("TemperatureScenarioReportArchive", isDirectory: true)
    }

    func archive(_ snapshot: HeizBalanceTemperatureScenarioReportSnapshot) throws -> URL {
    ...
    private func archiveFilename(snapshot: HeizBalanceTemperatureScenarioReportSnapshot) -> String {
